...
<div class="box-body">
    <form action="marbout_updatemutasi/{{ $tbl_mutasiID->id_mutasi }}" enctype="multipart/form-data" method="post"
            ...
            <div class="col-lg-5">
                <div class="form-group row">
                    <label for="tglskmutasi" class="col-lg-4 col-form-label">Tanggal
                        SK</label>
                    <div class="col-lg-8">
                        <input name="tglskmutasi" type="date" class="form-control text-left" id="tglskmutasi"
        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <input name="keteranganmutasi" type="text" class="form-control" id="keteranganmutasi"
                            value="{{ $tbl_mutasiID->keterangan_mutasi }}">
                    </div>
                </div>
            </div>
            <div class="col-lg-1"></div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <input type="file" class="form-control" name="foto"
                            value="{{ $tbl_mutasiID->filesk_mutasi }}" accept="image/*" placeholder="Pas Photo"
                            class="form-control" id="fileInput" onchange="previewFile()">
                    </div>
                    <div class="col-lg-6">
