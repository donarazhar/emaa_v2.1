<div class="card card-header bg-dark">
    <i class="fas fa-scroll nav-icon">&nbsp;&nbsp;&nbsp;&nbsp;Mengedit Data Marbout</i>
</div>
<div class="box-body">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <label for="namamarbout" class="col-lg-3 col-form-label text-left">Nama
                                    Lengkap</label>
                                <div class="col-lg-9">
                                    <input type="text" id="namauser" class="form-control" name="namauser"
                                        value=" {{ $tbl_marbout->nama_user }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="unitkerja" class="col-lg-3 col-form-label text-left">Unit
                                    Kerja</label>
                                <div class="col-lg-9">
                                    <select id="id_unitkerja" class="form-control" name="id_unitkerja" required>
                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="form-group row">
                                        <label for="tempatlahir" class="col-lg-7 col-form-label text-left">Tempat,
                                            Tgl Lahir</label>
                                        <div class="col-lg-5">
                                            <input name="tempatlahir" type="text" class="form-control"
                                                id="tempatlahir" value="{{ $tbl_marbout->tempat_lahir }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-7">
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                            <input name="tgllahir" type="date" class="form-control text-left"
                                                id="tgllahir" value="{{ $tbl_marbout->tgl_lahir }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="statusnikah" class="col-lg-3 col-form-label text-left">Status
                                    Pernikahan</label>
                                <div class="col-lg-9">
                                    <select name="statusnikah" class="default-select2 form-control" required>
                            ...
                            <div class="form-group row">
                                <label for="statuskepeg" class="col-lg-3 col-form-label text-left">Status
                                    Kepegawaian</label>
                                <div class="col-lg-9">
                                    <select name="statuskepeg" class="default-select2 form-control" required>
