...
<div class="box-body px-5 py-3">
    <form action="frontlayanan_updatekategorilayanan/{{ $tbl_kategorilayananID->id_kategorilayanan }}" method="post"
        accept-charset="utf-8">
        @csrf
        <div class="form-group">
            <label for="namakategorilayananmodal">Nama</label>
            <input name="namakategorilayananmodal" type="text" class="form-control" id="namakategorilayananmodal"
                placeholder="Masukkan nama" value="{{ $tbl_kategorilayananID->nama_kategorilayanan }}" required>
        </div>
        <div class="form-group">
