...
<div class="box-body px-5 py-3">
    <form action="/frontlayanan_updatejeniskonsultasi/{{ $tbl_jeniskonsultasiID->id_jeniskonsultasi }}" method="post"
        accept-charset="utf-8">
        @csrf
        <div class="form-group">
            <label for="namajeniskonsultasimodal">Nama</label>
            <input name="namajeniskonsultasimodal" type="text" class="form-control" id="namajeniskonsultasimodal"
                placeholder="Masukkan nama" value="{{ $tbl_jeniskonsultasiID->nama_jeniskonsultasi }}" required>
        </div>
        <div class="form-group">
