                ...
                <div class="card card-primary card-tabs">
                    ...
                    <div class="card-header p-0 pt-1">
                        <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                            <li class="pt-2 px-3">
                                <h3 class="card-title"><strong>DATA LAYANAN</strong></h3>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" id="custom-tabs-two-messages-tab" data-toggle="pill"
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="custom-tabs-two-tabContent">
                                                                    ...
                                                                    <tbody>
                                                                        @foreach ($tbl_konsultasi as $konsultasi)
                                                                            <tr class="odd">
                                                                                ...
                                                                                <td>{{ $konsultasi->hari_fk }}/
                                                                                    {{ date('d-m-Y', strtotime($konsultasi->tgl_fk)) }}
                                                                                </td>
                                                                                <td>{{ $konsultasi->jam_fk }}</td>

                                                                                <td class="text-center inline-block">
                                                                                    <a class="fa fa-edit btn btn-xs btn-warning editkonsultasi"
                                                                                        href="#"
                                                                                        id="{{ $konsultasi->id_fk }}">
                                                                                    </a>
                                                                                    <form
                                                                                        action="/frontlayanan_hapusdatakonsultasi/{{ $konsultasi->id_fk }}"
                                                                                        method="POST">
                                                                                        @csrf
                                                                                        <a
                                                                                            class=" fa fa-trash-alt btn btn-danger btn-xs delete-konsultasi">
                                                                                        </a>
                                                                                    </form>
                                                                                </td>
                                                                                <td>
                                                                                    <a href="/frontlayanan_cetakdatakonsultasi"
                                                                                        target="_blank"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-5">
                                                            <div class="form-group">
                                                                <label for="tglfkmodal">Tanggal</label>
                                                                <input name="tglfkmodal" type="date"
                            ...
                            <!-- PENGISLAMAN -->
                            <div class="tab-pane fade fade" id="custom-tabs-two-profile" role="tabpanel"
...
@push('myscript')
    <script>
        $(function() {
            ...
            $(".editkonsultasi").click(function() {
                var id = $(this).attr('id');
                $.ajax({
                    type: 'POST',
                    url: '/frontlayanan_editdatakonsultasi',
                    cache: false,
                    data: {
                        _token: "{{ csrf_token() }}",
                        id: id
                    ...
                    success: function(respond) {
                        $('#loadeditformkonsultasi').html(respond);
                    }
                });
                $("#modal-editdatakonsultasi").modal("show");
            });
            // Proses delete dengan AJAX
            $(".delete-konsultasi").click(function(e) {
