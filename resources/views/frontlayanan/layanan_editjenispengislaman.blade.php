    ...
    <div class="box box-primary box-solid">
        <div class="card card-dark">
            ...
            <div class="box-body px-5 py-3">
                <form action="/frontlayanan_updatejenispengislaman/{{ $tbl_jenispengislamanID->id_jenispengislaman }}"
                    method="post" accept-charset="utf-8">
                    @csrf
                    <div class="form-group">
                        <label for="namajenispengislamanmodal">Nama</label>
                        <input name="namajenispengislamanmodal" type="text" class="form-control"
                            id="namajenispengislamanmodal" placeholder="Masukkan nama"
                            value="{{ $tbl_jenispengislamanID->nama_jenispengislaman }}" required>
                    </div>
                    <div class="form-group">
