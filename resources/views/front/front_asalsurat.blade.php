...
@section('content')
                    ...
                    <div class="card-body">
                        <div class="card card-dark card-outline">
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-lg-10">
                                    <form action="/front_tambahasalsurat" method="post" accept-charset="utf-8">
                                        @csrf
                                        <div class="row">
                                            <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-7">
                                                <input name="kodeasalsurat" type="text" class="form-control"
                                                    id="kodeasalsurat" required>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                                <input name="namaasalsurat" type="text" class="form-control"
                                                    id="namaasalsurat" required>
                                            </div>
                                            <div class="col-lg-3"></div>
                                        </div>
                                        <div class="row">
                                                    ...
                                                    <tbody>
                                                        @foreach ($tbl_asalsurat as $asalsurat)
                                                            <tr>
                                                                ...
                                                                <td><small>{{ $asalsurat->kode_asalsurat }}</small>
                                                                <td><small>{{ $asalsurat->nama_asalsurat }}</small>
                                                                <td><small>{{ $asalsurat->deskripsi }}</small>
                                                                </td>
                                                                <td>
                                                                    <a class="fa fa-edit btn btn-xs btn-warning edit"
                                                                        href="#" id="{{ $asalsurat->id_asalsurat }}">
                                                                    </a>
                                                                    <form
                                                                        action="/front_hapusasalsurat/{{ $asalsurat->id_asalsurat }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        <a
    ...
    <div class="modal modal-blur fade" id="modal-editfrmasalsurat" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <script>
        $(function() {
            ...
            $(".edit").click(function() {
                ...
                $("#modal-editfrmasalsurat").modal("show");
            });
