    ...
    <div class="box box-primary box-solid">
        <div class="card card-dark mt-2">
            ...
            <div class="box-body px-5">
                <form action="/front_updatedatasurat/{{ $tbl_datasuratID->id_transaksisurat }}" method="post"
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="no_modaltransaksisurat"
                                        name="no_modaltransaksisurat" value="{{ $tbl_datasuratID->no_transaksisurat }}"
                                        required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="tglmodaltransaksisurat" type="date"
                                        id="tglmodaltransaksisurat" value="{{ $tbl_datasuratID->tgl_masuksurat }}"
                                        required>
                                </div>
                            </div>
                        </div>
